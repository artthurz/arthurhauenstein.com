  ...
  return (
    <section id="projects">
      <div className="mb-6 max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <h2 className="mt-8 font-semibold text-violet-500 dark:text-violet-400">
          {t("section")}
        </h2>
      ...
      <div className="relative pt-10 xl:pt-0 mt-10 xl:mt-2">
        ...
        <div className="absolute top-0 inset-x-0 bg-top bg-no-repeat bg-beams-light dark:bg-beams-dark bg-size-[125.5rem] h-160 xl:top-8" />
